...
type TresRendererErrorCode = 'INITIALIZATION_FAILED';
declare class TresRendererError extends Error {
  readonly code: TresRendererErrorCode;
  readonly name = "TresRendererError";
  constructor(message: string, code: TresRendererErrorCode, options?: ErrorOptions);
}
//#endregion
...
declare function useRendererManager({
  ...
  onError: _vueuse_core0.EventHookOn<TresRendererError>;
  invalidate: (amountOfFramesToInvalidate?: number) => void;
  canBeInvalidated: vue4.ComputedRef<boolean>;
  mode: "always" | "on-demand" | "manual" | undefined;
  replaceRenderFunction: (fn: RenderFunction) => void;
  isInitialized: vue4.Ref<boolean, boolean>;
  error: vue4.Ref<TresRendererError | null, TresRendererError | null>;
};
...
declare const __VLS_export$1: <T extends TresObjectMap>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_exposed?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
  props: vue4.PublicProps & __VLS_PrettifyLocal<{
    /**
...
declare const useGraph: (object: MaybeRef$1<TresObject | undefined>) => vue4.ComputedRef<TresObjectMap | undefined>;
//#endregion
...
declare const useLoop: () => {
  stop: () => void;
  start: () => void;
  isActive: Readonly<vue4.ShallowRef<boolean>>;
...
declare const __VLS_base: vue4.DefineComponent<ContextProps, TresCanvasInstance, {}, {}, {}, vue4.ComponentOptionsMixin, vue4.ComponentOptionsMixin, {
...
}, string, vue4.PublicProps, Readonly<ContextProps> & Readonly<{
 ...
 * ```
 */
declare const isScene: (value: unknown) => value is Scene<THREE.Object3DEventMap>;
/**
